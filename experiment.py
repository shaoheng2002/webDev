...
def part_1a():
    ...
    coords, state = assignment1.traffic_light_detection(simple_tl, radii_range)
...
def part_1b():
    ...
    coords, state = assignment1.traffic_light_detection(scene_tl_1, radii_range)
    ...
    coords, state = assignment1.traffic_light_detection(scene_tl_2, radii_range)
...
def part_2a():
    ...
    signs = assignment1.traffic_sign_detection(scene_some_signs)
...
def part_2b():
    ...
    signs = assignment1.traffic_sign_detection(scene_all_signs)
...
def part_3():
    ...
    signs = assignment1.traffic_sign_detection(noisy_scene_all_signs)
